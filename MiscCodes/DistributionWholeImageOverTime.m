function DistributionWholeImageOverTime(exportFolder, fileExportFolder, fileParams, flowDistParams)
%% Import Parameters
...
DistributionSingleCellOverTime(fileExportFolder, 'HistogramTimeData.mat', relMat, diffIm, magMat, angMat, dataBinWidth, relThresh);